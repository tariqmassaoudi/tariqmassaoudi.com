...
const ProductCard = ({name,data,loading}) => {
    ...
    if(loading){
        return (
            <div class="bg-white p-2 sm:p-4 sm:h-64 rounded-lg shadow-md flex flex-col sm:flex-row gap-5 select-none mb-2 px-2">
    ...
    <a  className="text-sm font-medium text-gray-900">{data.reviewcount} reviews</a>
</div>
