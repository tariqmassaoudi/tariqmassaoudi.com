...
if(loading){
    return(         <div class="bg-white p-2 sm:p-4 h-96 rounded-lg shadow-md flex flex-col sm:flex-row gap-10 select-none mb-2 px-2">
    <div class="h-52 sm:h-full sm:w-80 rounded-xl bg-gray-200 animate-pulse" ></div>
    <div class="flex flex-col flex-1 gap-5 sm:p-2">
      <div class="flex flex-1 flex-col gap-3">
        <div class="bg-gray-200 w-full animate-pulse h-14 rounded-2xl" ></div>
        <div class="bg-gray-200 w-1/4 animate-pulse h-3 rounded-2xl" ></div>
        <div class="bg-gray-200 w-full animate-pulse h-14 rounded-2xl" ></div>
        <div class="bg-gray-200 w-1/4 animate-pulse h-3 rounded-2xl" ></div>
        <div class="bg-gray-200 w-1/4 animate-pulse h-3 rounded-2xl" ></div>
        <div class="bg-gray-200 w-1/4 animate-pulse h-3 rounded-2xl" ></div>
      ...
      <div class="mt-auto flex gap-3">
        <div class="bg-gray-200 w-52 h-10 animate-pulse rounded-full" ></div>

        <div class="bg-gray-200 w-52 h-10 animate-pulse rounded-full ml-auto" ></div>
      </div>
    </div>
</div>)
}else{
...
<div className="min-w-screen font-sans  flex items-top overflow-hidden relative mb-12">
            ...
            <a  className="text-sm font-medium text-gray-900">{reviewcount} reviews</a></div>
            :''}
          ...
          <li>Shipped From: {etranger?"Abroad": "Morocco"} </li>
                        ...
                        <div className="grid grid-cols-2">
                            ...
                            <div className="my-auto ml-4">
                                <a href={'https://jumia.ma'+href} target="_blank" className="lg:px-20 md:px-10 px-10  py-2 font-semibold text-white bg-green-700 rounded-full hover:bg-green-800 " > Buy On Jumia</a>
                            </div>
                        </div>
                    </div>
                </div>
